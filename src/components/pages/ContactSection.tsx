      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="text-center p-8 hover:shadow-lg transition-all duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold hospital-green mb-2">
              Contact Numbers
            </h3>
            <p className="text-lg font-bold hospital-blue">
          ...
          <Card className="text-center p-8 hover:shadow-lg transition-all duration-300 hover:scale-105">
            ...
            <p className="text-lg font-bold hospital-blue mb-2">
              PAVAN SAI HOSPITALS
            </p>
            <p className="text-sm text-gray-700">
              (ORTHOPAEDIC - NEURO & GENERAL)
            </p>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Choose your preferred way to schedule an appointment with our
                  medical team.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <div className="space-y-4 py-4">
                ...
                <Button
                  ...
                  onClick={() => {
                    toast.info(
                      "Please call +91 9999 XXXX XX to book your appointment",
                    );
                  }}
                >
                  📞 Call to Book
                ...
                <Button
                  ...
                  onClick={() => {
                    toast.info(
                      "Visit us at 123 Healthcare Street for walk-in appointments",
                    );
                  }}
                >
                  🏥 Walk-in
