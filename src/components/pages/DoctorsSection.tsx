                    ...
                    {otherDoctors.map((doc, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`group p-2.5 px-3.5 lg:p-3.5 lg:px-4 bg-slate-50/50 hover:bg-white border border-transparent hover:border-hospital-blue/20 rounded-2xl flex items-center gap-3 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 cursor-default ${
