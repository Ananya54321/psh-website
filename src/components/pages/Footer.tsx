export function Footer() {
  return (
    <footer className="bg-hospital-blue text-white py-10 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-lg font-bold hospital-orange">
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p className="opacity-90">
            © 2024 Pavan Sai Hospitals. All rights reserved. | Changing lives
            since 2008
          </p>
        </div>
      </div>
