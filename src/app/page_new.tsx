...
export default function Home() {
  const services = [
    {
      ...
      description:
        "24/7 emergency medical services with state-of-the-art facilities and rapid response team",
      icon: "🚨",
    ...
    },
    {
      title: "Cardiology",
      description:
        "Advanced heart care with experienced cardiologists, cardiac surgery, and modern equipment",
      icon: "❤️",
      category: "Specialty",
    ...
    },
    {
      title: "Neurology",
      description:
        "Comprehensive brain and nervous system care with cutting-edge neurological treatments",
      icon: "🧠",
      category: "Specialty",
    ...
    },
    {
      ...
      description:
        "Comprehensive prenatal and postnatal care for mothers and babies in a safe environment",
      icon: "👶",
    ...
    },
    {
      title: "Oncology",
      description:
        "Advanced cancer care with latest treatment modalities and comprehensive support",
      icon: "🎗️",
      category: "Specialty",
      color: "hospital-orange",
    },
    {
      ...
      description:
        "Advanced surgical procedures with skilled surgeons and modern technology",
      icon: "🏥",
      category: "Surgery",
      color: "hospital-blue",
    },
    {
      title: "Diagnostics",
      description:
        "Complete diagnostic services including lab tests, imaging, and advanced screening",
      icon: "🔬",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Excellent care and professional staff. The doctors are very knowledgeable and caring.",
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Best hospital in the city. Clean facilities and prompt service. Highly recommended!",
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Outstanding emergency care. The staff acted quickly and saved my father's life.",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="gradient-hospital-blue text-white py-4 px-6 shadow-2xl sticky top-0 z-50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-8">
            <a
              href="#home"
              className="hover:text-hospital-orange transition-all duration-300 font-medium"
            >
              Home
            </a>
            <a
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slideInLeft">
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-xl">
                At Pawan Sai Hospitals, we provide world-class healthcare
                services with compassion, expertise, and cutting-edge medical
                technology. Your well-being is our unwavering commitment.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 mb-12">
                ...
                <Button
                  variant="outline"
                  className="border-2 border-hospital-green text-hospital-green hover:bg-hospital-green hover:text-white px-10 py-4 text-lg font-semibold"
                >
              ...
              <div className="relative">
                <div className="gradient-hospital-blue rounded-3xl p-8 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="bg-white rounded-2xl p-8 text-center transform -rotate-3">
                    ...
                    <h3 className="text-2xl font-bold hospital-green mb-4">
                      Excellence in Healthcare
                    </h3>
                    <p className="text-gray-600 leading-relaxed">
                      Modern facilities, experienced doctors, personalized care,
                      and innovative treatments
                    </p>
                    <div className="mt-6 flex justify-center space-x-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold hospital-blue">
                          98%
                        </div>
                        <p className="text-xs text-gray-500">Satisfaction</p>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold hospital-green">
                          500+
                        </div>
                        <p className="text-xs text-gray-500">Beds</p>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold hospital-orange">
                          15
                        </div>
                ...
                <div
                  className="absolute -bottom-4 -left-4 w-16 h-16 bg-hospital-green/20 rounded-full animate-pulse"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl opacity-90">
              Trusted by thousands, serving with pride
            </p>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center animate-scaleIn card-hover"
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 animate-fadeInUp">
            <Badge className="mb-4 bg-hospital-orange text-white px-4 py-2">
              🏥 Our Specialties
            </Badge>
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We offer world-class healthcare services across multiple
              specialties with state-of-the-art facilities and experienced
              medical professionals dedicated to your well-being and recovery.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="service-card card-hover animate-fadeInUp border-0 shadow-lg"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <CardHeader className="text-center pb-4">
                  <div
                    className={`service-icon text-5xl mb-4 ${service.color}`}
                  >
                    {service.icon}
                  </div>
                  <Badge
                    className={`bg-${service.color} text-white mb-3 w-fit mx-auto px-3 py-1`}
                  >
                    {service.category}
                  </Badge>
                  <CardTitle className="hospital-green text-xl font-bold">
                    {service.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="pt-0">
                  ...
                  <Button
                    variant="ghost"
                    className={`mt-4 w-full text-${service.color} hover:bg-${service.color} hover:text-white transition-all duration-300`}
                  >
                    Learn More →
                  </Button>
                </CardContent>
      ...
      <section id="about" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="animate-slideInLeft">
              <Badge className="mb-6 bg-hospital-blue text-white px-4 py-2">
                🏆 About Us
              </Badge>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Since 1985, Pawan Sai Hospitals has been a beacon of hope and
                healing in our community. We combine cutting-edge medical
              ...
              <div className="space-y-6 mb-10">
                {[
                  {
                    icon: "👨‍⚕️",
                    text: "Board-certified medical professionals",
                  },
                  ...
                  <div
                    key={index}
                    className="flex items-center space-x-4 animate-scaleIn"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                <h4 className="font-bold text-lg hospital-blue mb-4">
                  🏆 Awards & Recognition
                </h4>
            ...
            <div className="animate-slideInRight">
              <div className="relative">
                <div className="gradient-hospital-blue rounded-3xl p-10 text-white shadow-2xl">
                  <div className="text-center">
                    ...
                    <p className="text-lg leading-relaxed opacity-95 mb-8">
                      To provide exceptional healthcare services that improve
                      the quality of life for our patients and community through
                      innovative medical practices, compassionate care, and
                      continuous improvement.
                    </p>
                    <div className="grid grid-cols-1 gap-6 text-center">
                      <div>
                        <div className="text-3xl font-bold hospital-orange">
                          98%
                        </div>
                        <p className="text-sm opacity-90">
                ...
                <div
                  className="absolute -bottom-6 -left-6 w-16 h-16 bg-hospital-green rounded-full opacity-20 animate-pulse"
                  style={{ animationDelay: "1s" }}
                ></div>
              </div>
            </div>
      ...
      <section
        id="testimonials"
        className="py-24 px-6 bg-gradient-to-br from-blue-50 to-green-50"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fadeInUp">
            <Badge className="mb-4 bg-hospital-green text-white px-4 py-2">
              ⭐ Patient Stories
            </Badge>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="card-hover animate-fadeInUp shadow-lg border-0"
                style={{ animationDelay: `${index * 0.2}s` }}
              >
                <CardContent className="p-8">
                  ...
                  <div className="border-t pt-4">
                    <p className="font-semibold hospital-blue">
                      {testimonial.name}
                    </p>
      ...
      <section id="contact" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 animate-fadeInUp">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to prioritize your health? Contact us today for
              appointments, emergencies, or any healthcare inquiries.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <Card className="text-center p-8 card-hover shadow-lg border-l-4 border-l-hospital-blue animate-fadeInUp">
              ...
              <h3 className="text-xl font-bold hospital-blue mb-4">
                Emergency Hotline
              </h3>
              <p className="text-3xl font-bold hospital-green mb-2">
                +91 9999-XXXX-XX
              </p>
            ...
            <Card
              className="text-center p-8 card-hover shadow-lg border-l-4 border-l-hospital-green animate-fadeInUp"
              style={{ animationDelay: "0.1s" }}
            >
              <div className="text-5xl mb-6">📍</div>
              <h3 className="text-xl font-bold hospital-green mb-4">
                Our Location
              </h3>
              ...
              <Button
                variant="ghost"
                className="mt-3 text-hospital-green hover:bg-hospital-green hover:text-white"
              >
                Get Directions
              </Button>
            </Card>
            ...
            <Card
              className="text-center p-8 card-hover shadow-lg border-l-4 border-l-hospital-orange animate-fadeInUp"
              style={{ animationDelay: "0.2s" }}
            >
              <div className="text-5xl mb-6">🕒</div>
              <h3 className="text-xl font-bold hospital-orange mb-4">
                Visiting Hours
              </h3>
            ...
            <Card
              className="text-center p-8 card-hover shadow-lg border-l-4 border-l-hospital-blue animate-fadeInUp"
            ...
            >
              ...
              <p className="text-gray-700 mb-2">
                appointments@pawansaihospitals.com
              </p>
              <Button
                variant="ghost"
                className="mt-3 text-hospital-blue hover:bg-hospital-blue hover:text-white"
              >
                Send Email
              </Button>
            </Card>
          ...
          <div className="text-center bg-gradient-to-r from-hospital-blue to-hospital-green rounded-3xl p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-hospital-blue px-10 py-4 text-lg font-semibold"
              >
                📞 Call Now
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="opacity-90 leading-relaxed mb-6 max-w-md">
                ...
                compassion, innovation, and medical excellence. Your health and
            ...
            <div>
              ...
              <ul className="space-y-3 opacity-90">
                <li>
                  <a
                    href="#home"
                    className="hover:text-hospital-orange transition-colors"
                  >
                    Home
                  </a>
                </li>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-2xl font-bold hospital-orange">
                    +91 9999-XXXX-XX
                  </p>
                </div>
                <div>
                ...
                <div>
                  <p className="opacity-90">
                    Email: info@pawansaihospitals.com
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="opacity-90 mb-4 md:mb-0">
              © 2024 Pawan Sai Hospitals. All rights reserved. | Caring for Your
              Health
            </p>
